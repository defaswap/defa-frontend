...
export const DEFAULT_META: PageMeta = {
  title: 'DEFA',
  description:
    'The most popular AMM on BSC by user count! Earn DEFA through yield farming or win it in the Lottery, then stake it in Nosha Pools to earn more tokens!',
  image: 'https://defa.finance/images/hero.png',
}
